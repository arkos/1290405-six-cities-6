...
const PropertyCard = ({cardClass, offer, onEnter, onLeave}) => {
  ...
  return (
    <article className={`${cardClass}__property-card place-card`} onMouseEnter={() => onEnter(id)} onMouseLeave={() => onLeave(id)}>
